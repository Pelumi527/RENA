...
import { COLLECTION_ADDRESS, COLLECTION_ID, RENA_MODULE_TESTNET } from "../util/module-endpoints";
...
export class Queries {
    ...
    async getRenegadesNFTs(
        ...
        const response = await this.aptos.getAccountOwnedTokensFromCollectionAddress({
            accountAddress,
            // collectionAddress
