...
const SideBar = () => {
    ...
    const animationClass = isOpen ? 'animate-slideDown' : 'animate-slideUp';
        ...
        <div className={`${animationClass} fixed inset-0 w-full bg-primary z-[100] flex flex-col px-5 pt-10 pb-12`}>
            <div className="flex flex-col w-full">
                <div className="flex justify-between items-center">
                    <div className="flex items-center" style={{ zIndex: 100 }}>
                        <img onClick={() => {navigate('/'); dispatch(toggleSidebar(false))}}
                            src="/logo-white.svg"
            ...
            <div className="flex flex-col justify-between flex-grow">
                ...
                <div className="flex flex-col gap-8 flex-shrink-0">
                    <Link to={'/claim'}><p onClick={() => dispatch(toggleSidebar(false))} className="text-[26px] font-semibold text-center leading-[30px]" >Claim or Liquify NFT</p></Link>
                    <Link to={'/renegades'}><p onClick={() => dispatch(toggleSidebar(false))} className="text-[26px] font-semibold text-center leading-[30px]" >My Renegades</p></Link>
                </div>
