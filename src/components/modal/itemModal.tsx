...
const ItemModal = () => {
  ...
  return (
    ...
    >
        ...
        <div className="relative w-[566px] h-[510px] bg-[#222] border-gray-light-3 rounded-[8px] p-6">
          <div className="flex flex-col w-full">
            ...
            <div className="flex justify-center gap-6 my-6 items-center">
              <SecondaryButton className="!font-bold w-[203px] h-12">Cancel</SecondaryButton>
              <PrimaryButton onClick={() => setLiquify(2)} className="!font-bold w-[253px] h-12">Liquify NFT and get 1 $RENA</PrimaryButton>
            </div>
            ...
            <div className="flex flex-col w-[388px]">
              ...
              <div className="flex flex-wrap mt-[30px] justify-between gap-y-2 border-b border-[#666] pb-4">
                {dataItems.map((item, index) => (
                  <div key={index} className="w-[188px] h-[82px] rounded-[8px] border-[#666] border flex flex-col items-start px-3 py-[11px]">
              ...
              <p className="text-[18px] font-semibold text-[#FFF] mt-4 leading-[130%]">Do you want to get 1 $RENA embedded in this NFT? <br />Liquify NFT to retrieve your 1 $RENA</p>
              <button onClick={() => setLiquify(1)} className="mt-3 rounded-[4px] w-[200px] h-12 text-[18px] text-[#121221] bg-[#FFF] font-bold">Liquify NFT</button>
            </div>
          </div>
        </div>
      }
      ...
      {liquify == 2 &&
        < div style={{ backgroundImage: `url("/renegades/bg-modal-success.png")`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }} className="relative w-[566px] h-[425px] bg-[#222] border-gray-light-3 rounded-[8px] p-6">
          <div className="flex flex-col w-full">
            <div className="flex justify-between items-center">
            ...
            <div className={`flex flex-col items-center justify-between mt-10`} >
              <div className="flex flex-col items-center">
                ...
                <p className="text-[22px] font-bold mt-3 leading-[24px]" >Hooray! You’ve got your $RENA back!</p>
                <p className="text-[18px] font-semibold" >If you want you can use it to claim a new Renegades NFT!</p>
              </div>
