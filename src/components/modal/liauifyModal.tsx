        ...
        <div className="overflow-y-scroll relative w-full sm:w-[566px] h-[625px] sm:h-[510px] bg-[#222] border-gray-light-3 rounded-[8px] p-4">
          <div className="flex flex-col w-full">
            <div className="flex justify-between items-center">
              <p className="text-[26px] font-semibold text-[#FFF] leading-[30px]">Proceed and liquify {data?.token_name}?</p>
            ...
            <div className="flex my-8 sm:my-12 items-center justify-center">
              <img src={data?.token_uri} className="w-[150px] h-[150px] rounded-[8px]" />
      ...
      {liquify == 0 &&
        < div className="relative w-full sm:w-[965px] h-[95%] sm:h-[545px] bg-[#222] border-gray-light-3 rounded-[8px] py-6 px-4 sm:px-6 overflow-y-scroll">
          <div className="flex w-full justify-between">
            <img src={data?.token_uri} className="hidden sm:block w-[328px] h-[328px] sm:w-[497px] sm:h-[497px] rounded-lg" />
            <div className="flex flex-col w-[388px]">
              <div className="flex justify-between h-[62px]">
                <div className="flex flex-col items-start">
                  <p className="text-[32px] font-bold leading-[38px]">{data?.token_name}</p>
              ...
              <div className="flex justify-center">
                <img src={data?.token_uri} className="block sm:hidden w-full sm:w-[497px] sm:h-[497px] rounded-lg mt-8" />
              </div>
