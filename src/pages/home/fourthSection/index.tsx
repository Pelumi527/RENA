  ...
  return (
    <div className="w-full h-fit z-20 relative">
      <div className="w-full h-full flex flex-col items-center justify-center">
        <div className="flex flex-col mt-[352px] w-[901px] items-center">
        ...
        <div className="w-[1100px] h-[363px] flex flex-col mt-[72px] border border-[#666] rounded-[8px]">
          <div className="flex flex-row h-[120px] border-b border-[#666]">
            <div className="w-[581px]" />
            <div className="w-[260px] flex flex-col items-center justify-center border-x border-[#666]">
          ...
          {comparisonData.map(({ feature, liquidNFT, erc404 }) => (
            <div key={feature} className="flex flex-row h-[82px] border-b border-[#666]">
              <div className="w-[580px] flex items-center">
                <p className="text-[22px] font-semibold ml-8">{feature}</p>
              </div>
              <div className="w-[259px] flex flex-col items-center justify-center border-x border-[#666]">
                <img
                  src={`/home/fourth/${liquidNFT ? 'check' : 'x'}-icon.svg`}
                  className="w-8 h-8 cursor-pointer"
                />
              </div>
              <div className="w-[259px] flex flex-col items-center justify-center">
                <img
