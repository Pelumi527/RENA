  ...
  return (
    <div className="w-full h-fit z-20 relative" >
      <div className="w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="w-[95%] lg:w-[1100px] h-[335px] flex flex-col mt-6 lg:mt-16">
          <div className="w-full flex justify-between">
            <div className="flex mt-10">
              <div className="flex flex-col items-center">
                ...
                />
                <p className="text-[18px] lg:text-[22px] text-gray-light font-semibold w-[112px] text-center">Get 1 $RENA token</p>
              </div>
              <img
            ...
            <div className="flex mt-10">
              <div className="flex flex-col items-center">
                ...
                />
                <p className="text-[18px] lg:text-[22px] text-gray-light font-semibold w-[220px] text-center">Claim 1 Renegades NFT with $RENA</p>
              </div>
              <img
                src="home/third/arrow-left.svg"
                className="w-[9px] h-[17px] cursor-pointer mb-4 mt-9"
            ...
            <div className="flex mt-10">
              <div className="flex flex-col items-center">
                <img
                  ...
                  className="w-[191px] h-[97px] cursor-pointer mb-4"
                />
                <p className="text-[18px] lg:text-[22px] text-gray-light font-semibold w-[200px] text-center">Your 1 $RENA token is embedded to the Renegades NFT</p>
              </div>
              <img
                src="home/third/arrow-left.svg"
                className="w-[9px] h-[17px] cursor-pointer mb-4 mt-9"
            ...
            <div className="flex">
              <div className="flex flex-col items-center">
                ...
                />
                <p className="text-[18px] lg:text-[22px] text-gray-light font-semibold w-[263px] text-center">Your 1 $RENA token is embedded to the Renegades NFT</p>
              </div>
            </div>
          </div>
